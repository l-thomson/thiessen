...
| [Linear cell basis](https://l-thomson.github.io/thiessen/r/articles/linear-cells.html) | cell basis (model-grade validation) | `mean_params.cell.basis` entry `"linear"` | `term_params(cell = cell_params(basis = "linear"))` | `TermParams(cell=CellParams(basis="linear"))` | 0.3.0 | known answer; SBC and Geweke, both sizes; broken-sampler fixture | experimental | [#68](https://github.com/l-thomson/thiessen/pull/68) |
