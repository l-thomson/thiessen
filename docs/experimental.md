...
| DART inclusion (Linero 2018; not the Dirichlet AddiVortes of Stone and Gosling) | inclusion prior (model-grade validation) | `structure.inclusion` entry `{"dart": {"a": ..., "b": ..., "rho": ...}}` | `structure_params(inclusion = dart_inclusion())` | `StructureParams(inclusion=dart_inclusion())` | 0.3.0 | SBC and Geweke, both sizes; broken-sampler fixture | experimental | [#67](https://github.com/l-thomson/thiessen/pull/67) |
